...
<div class="card card-signup">
								...
								<div class="header header-primary text-center">
									...
									<h4 class="textoamarillo sombra">Resumen de la Orden para Confirmar su Envío</h4>
						 ...
						 <tr>
						 	...
						 	<td align="center">
						 		<form method="post" action="confirmaorden.php">
							 		<p><input type="submit" name="ordenar" value="Confirmar orden" class="btn btn-primary btn-block"></p>
						 		</form>
						 	</td>
						 </tr>
					</table>
