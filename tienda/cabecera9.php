...
<div class="card card-signup">
								...
								<div class="header header-primary text-center">
									...
									<h4 class="textoamarillo sombra">Seguimiento de Órdenes Activas</h4>
			...
			<tr>
				<td valign="top" align="center" colspan="3">
					<div style="vertical-align:top;">
						...
						?>
			            <br>
			            <form action="inicio.php"><INPUT type="submit" value="Volver al catálogo" class="btn btn-primary btn-block"></form>
