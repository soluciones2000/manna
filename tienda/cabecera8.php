...
<div class="card card-signup">
								...
								<div class="header header-primary text-center">
									...
									<h4 class="textoamarillo sombra">Reportar Pago</h4>
						...
						<div style="margin: 0% 15%">
					        <form name="pago" method="post" action="guardapago.php">
					            <table border=0>
					            	<tr>
					            		<td></td>
					            		<td><INPUT type="text" name="nombre" class="form-control" placeholder="Numero Depositante..." value="<?php echo $nombre; ?>" maxlength="150" size="50" readonly><br></td>
					            	</tr>
					            	<tr>
					            		<td></td>
<!--
...
-->
										...
										<td><input type="date" name="fecha" size="10" required class="form-control" placeholder="Indique Fecha de Pago..." value="<?php echo date('Y-m-d');  ?>" /></td>
					            	</tr>
					            	<tr>
					            		<td></td>
					            		<td><INPUT type="text" name="documento" maxlength="20" size="20" pattern="[0-9]{0,20}" class="form-control" placeholder="Introduzca el Número de Comprobante (Sólo Números)..." required><br></td>
					            	</tr>
					            	<tr>
					            		<td></td>
					            		<td><INPUT type="text" name="bancoorigen" maxlength="150" size="50" class="form-control" placeholder="Introduzca el Nombre del Banco de Origen"><br></td>
					            	</tr>
					            	<tr>
					            		<td></td>
					            		<td><INPUT type="currency" name="monto" maxlength="20" size="20" pattern="\d+(.\d{2})?" class="form-control" placeholder="Introduzca el Monto Usando el Punto (.) como Separador Decimal" style="text-align:right" required><br></td>
					            	</tr>
					            	<tr>
					            		<td></td>
					            		<td><INPUT type="text" name="orden_id" maxlength="20" size="20"  pattern="[0-9]{0,20}" class="form-control" placeholder="Introduzca el Número de la Orden que Está Cancelando (Sólo Números)" style="text-align:right"><br></td>
					            	</tr>
					            </table>
