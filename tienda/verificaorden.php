					...
					<table border="0" width="auto" align="center">
						 <tr>
						 	<!-- <td colspan="4" style="padding-right:2%;padding-left:2%;"> -->
						 		...
						 		<!-- <p align="justify">En tal sentido, si usted realiza el pago por medio electrónico usted deberá cancelar la cantidad de Bs. -->
						 		<!-- <?php
						 		// 	if ($subtotal>2000000) {
								...
								?></p>-->
						 	<!-- </td> -->
						 	<!-- <td  colspan="5" style="padding-right:1%;" align="right"> -->
						 	<td align="center">
