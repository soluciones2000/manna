...
<div class="card card-signup">
								...
								<div class="header header-primary text-center">
									...
									<h4 class="textoamarillo sombra">Datos del Cliente</h4>
						...
						<div style="margin: 0% 15%">
					        <form name="pago" method="post" action="guardadatos.php">
					            <table border=0>
					            	<tr>
					            		<td></td>
					            		<td><INPUT type="email" name="email" value="<?php echo $_SESSION["email"]; ?>" maxlength="150" size="50"  class="form-control" placeholder="Indique Email..."readonly><br></td>
					            	</tr>
					            	<tr>
					            		<td></td>
					            		<td><INPUT type="text" name="nombre" maxlength="150" size="50" class="form-control" placeholder="Indique su Nombre..." required><br></td>
					            	</tr>
					            	<tr>
					            		<td></td>
					            		<td><INPUT type="text" name="cedula" maxlength="10" size="10" class="form-control" placeholder="Indique la Cedula..." required><br></td>
					            	</tr>
					            	<tr>
					            		<td></td>
					            		<td><INPUT type="text" name="telefono" maxlength="50" size="50" class="form-control" placeholder="Indique el Telefono..." required><br></td>
					            	</tr>
					            	<tr>
					            		<td></td>
										<td><textarea type="text" name="direccion" maxlength="500" rows="2" cols="50" class="form-control" placeholder="Indique Dirección Fiscal..." required></textarea><br></td>
					            	</tr>
					            	<tr>
					            		<td></td>
										<td><textarea type="text" name="direccion_envio" maxlength="500" rows="2" cols="50" class="form-control" placeholder="Indique Dirección de Envio..."></textarea><br></td>
					            	</tr>
					            </table>
