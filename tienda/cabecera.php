...
?>
							...
							<form name="admin" method="post" action="acceso.php">
								<div class="header header-primary text-center">
									...
									<h4 class="textoamarillo sombra">Introduzca su Numero de Tienda:</h4>
			...
			<tr>
				<td valign="top">
					...
					<div style="vertical-align:top;">
						...
						<INPUT type="text" name="codigo" maxlength="5" size="15" class="form-control" placeholder="Numero de Tienda...">
						</div>
						...
						<INPUT type="text" name="nombre" maxlength="100" size="60" class="form-control" placeholder="Indique el Nombre..." required>				
