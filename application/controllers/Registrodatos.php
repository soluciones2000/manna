...
class Registrodatos extends CI_Controller {
...
// Comentario
	public function crea_organizacion($tit_codigo,$enrol_codigo){
		$registro = array(
	       	'padre' => $enrol_codigo,
	       	'hijo' => $tit_codigo
        );
...
// Comentario
	public function transaccion($fechapago,$tit_codigo,$tipo_afiliado,$tipo_kit,$numcomprobante,$bancoorigen){
...
// Comentario
	public function orden($tit_codigo,$tipo_afiliado,$tipo_kit,$direccion_envio,$nombre_completo,$cedula,$telefono,$comprobante,$email,$fechapago){
		switch ($tipo_afiliado) {
			case 'Premium':
				switch ($tipo_kit) {
					case 'Hogar':
...
// Comentario
	public function patrocinio($patroc_codigo,$tit_codigo,$fecha_afiliacion){
