	...
	<div class="col-md-12 center-block no-float">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				...
				<?php $hidden = array( 'tipo_persona' => 'Especialista' ); ?>
				<?php echo form_open('regmedico','class="form-horizontal"',$hidden); ?>
					...
					<div class="row">
						<div class="form_group">
							...
							<?php if (set_value('tipo_kit')==="Lq"): ?>
								<div class="radio-inline col-sm-6" >
									<div class="col-sm-3">
										<input type="radio" name="tipo_kit" id="tipo_kit" value="Lq" checked>Línea LQ
									</div>
									<div class="col-sm-3">
										<input type="radio" name="tipo_kit" id="tipo_kit" value="Todas">Todas las líneas
									</div>
								</div>
							<?php else: ?>
								<div class="radio-inline col-sm-6" >
