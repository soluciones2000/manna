	...
	<div class="col-md-12 center-block no-float">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<?php echo form_open('crea_user','',$hidden); ?>
					<div class="row">
						<div class="col-sm-6">
							<?php 
								if ($_POST["tipo_persona"]=="Natural"){
									echo '<label for="tit_nombres"><font color="red">(*)</font> Nombres del titular</label>';
								} else {
									echo '<label for="tit_nombres"><font color="red">(*)</font> Razón Social</label>';
								}
							?>
						...
						<div class="col-sm-6">
							<?php 
								if ($_POST["tipo_persona"]=="Natural"){
									echo '<label for="tit_apellidos"><font color="red">(*)</font> Apellidos del titular</label>';
								} else {
									echo '<label for="tit_nombres"><font color="red">(*)</font> Representante legal</label>';
								}
							?>
					...
					<div class="row" style="margin-top:1%">
						<div class="col-sm-3">
							<?php 
								if ($_POST["tipo_persona"]=="Natural"){
									echo '<label for="tit_cedula"><font color="red">(*)</font> Cédula de Identidad</label>';
									echo '<input type="text" name="tit_cedula" value="'.set_value('tit_cedula').'" class="form-control" id="tit_cedula" placeholder="Cédula de identidad" maxlength="8" minlength="6" pattern="[0-9]{6,8}" title="Sólo se aceptan números" required>';
								} else {
									echo '<label for="tit_cedula"><font color="red">(*)</font> C.I. Representante legal</label>';
									echo '<input type="text" name="tit_cedula" value="'.set_value('tit_cedula').'" class="form-control" id="tit_cedula" placeholder="Cédula de identidad" maxlength="9" minlength="6" pattern="[0-9]{6,9}" title="Sólo se aceptan números" required>';
								}
							?>
						</div>
						<div class="col-sm-3">
							<?php 
								if ($_POST["tipo_persona"]=="Natural"){
									echo '<label for="tit_rif"><font color="red">(*)</font> RIF (sin guiones)</label>';
									echo '<input type="text" style="text-transform:uppercase;" name="tit_rif" class="form-control" id="tit_rif" placeholder="RIF" maxlength="10" minlength="9" pattern="[V|E]{1}[0-9]{8,9}" title="El primer caracter debe ser la letra V ó E en Mayúscula" required>';
								} else {
									echo '<label for="tit_rif"><font color="red">(*)</font> RIF de la empresa (sin guiones)</label>';
									echo '<input type="text" style="text-transform:uppercase;" name="tit_rif" class="form-control" id="tit_rif" placeholder="RIF" maxlength="11" minlength="9" pattern="[J]{1}[0-9]{8,10}" title="El primer caracter debe ser la letra J en Mayúscula" required>';
								}
							?>
						</div>
					...
					<?php if ($_POST["tipo_persona"]=="Natural"): ?>
						<div class="row" style="margin-top:1%">
							...
							<div class="col-sm-3">
								<label for="tit_profesion"><font color="red">(*)</font> Profesión</label>
								<input type="text" name="tit_profesion" class="form-control" id="tit_profesion" placeholder="Profesión"  maxlength="150" required>
							</div>
						</div>
						<div class="row">
