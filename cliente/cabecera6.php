					        ...
					        <form name="pago" method="post" action="guardapago.php">
					            <table border=0>
					            	<tr>
					            		...
					            		<td><INPUT type="text" name="nombre" value="<?php echo $nombre; ?>" maxlength="150" size="50" class="form-control" readonly><br></td>
					            	</tr>
					            	<tr>
...
-->
										...
										<td><input type="date" name="fecha" class="form-control" size="10" class="form-control" required title="Introduzca la fecha del pago" value="<?php echo date('Y-m-d'); ?>" /></td>
					            	</tr>
					            	<tr>
					            		<td>Número del comprobante:</td>
					            		<td><INPUT type="text" name="documento" maxlength="20" size="20" class="form-control" pattern="[0-9]{0,20}" title="Introduzca el número de comprobante (sólo números)" required><br></td>
					            	</tr>
					            	<tr>
					            		<td>Banco de origen:</td>
					            		<td><INPUT type="text" name="bancoorigen" maxlength="150" class="form-control" size="50" title="Introduzca el nombre del banco de origen"><br></td>
					            	</tr>
					            	<tr>
					            		<td>Monto del pago:</td>
					            		<td><INPUT type="currency" name="monto" maxlength="20" class="form-control" size="20" pattern="\d+(.\d{2})?" title="Introduzca el monto usando el punto (.) como separador decimal" style="text-align:right" required><br></td>
					            	</tr>
					            	<tr>
					            		<td>Número de orden:</td>
					            		<td><INPUT type="text" name="orden_id" maxlength="20" size="20" class="form-control"  pattern="[0-9]{0,20}" title="Introduzca el número de la orden que está cancelando (sólo números)" style="text-align:right"><br></td>
					            	</tr>
					            </table>
					            <br>
