...
-- Tiempo de generación: 29-09-2017 a las 15:08:21
...
--
ALTER TABLE `afiliados`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Id del sistema', AUTO_INCREMENT=39;
--
...
--
ALTER TABLE `ordenes`
  MODIFY `orden_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
