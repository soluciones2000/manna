                                         ...
                                         <form name="admin" method="post" action="validapass.php">
                                             <table border="0" width="100%">
                                                <tr>
                                                   ...
                                                   <td><INPUT type="text" name="codigo" maxlength="5" size="5" class="form-control" placeholder="Indique Código..."></td>
                                                </tr>
                                                <tr>
                                                   <td>Password:</td>
                                                   <td><INPUT type="password" name="password" maxlength="20" size="20" class="form-control" placeholder="Indique Password..."></td>
                                                </tr>
                                                <tr>
                                                   <td>Confirme el Password:</td>
                                                   <td><INPUT type="password" name="password1" maxlength="20" size="20" class="form-control" placeholder="Confirmar Password..."></td>
                                                </tr>
                                                <tr>
                                                   <td>Pregunta de Seguridad:</td>
                                                   <td><INPUT type="text" name="pregunta" maxlength="50" size="20" class="form-control" placeholder="Pregunta Seguridad..."></td>
                                                </tr>
                                                <tr>
                                                   <td>Respuesta:</td>
                                                   <td><INPUT type="password" name="respuesta" class="form-control" placeholder="Respuesta Seguridad..." maxlength="50" size="20"></td>
                                                </tr>
                                                <tr>
