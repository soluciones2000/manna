...
//		if ($_SESSION['pm']+$puntos>50 and $_SESSION['pm']+$puntos<300) {
		if ($_SESSION['pm']>50 or $_SESSION['pm']+$puntos>50) {
			if ($_SESSION['pm']<300) {
				if ($_SESSION['pm']<=50) {
					$base = $_SESSION['pm'] + $puntos - 50;
				} else {
					$base = ($_SESSION['pm']+$puntos>=300) ? $_SESSION['pm'] + $puntos - 300 : $puntos ;
				}
