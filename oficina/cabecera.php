                                         ...
                                         <form name="admin" method="post" action="acceso.php">
                                             <table border="0" width="100%">
                                                <tr>
                                                   ...
                                                   <td><INPUT type="tect" name="codigo" class="form-control" placeholder="Código del Asociado..." maxlength="5" size="5"></td>
                                                </tr>
                                                <tr>
                                                   <td>Password: </td>
                                                   <td><INPUT type="password" name="password" class="form-control" placeholder="Indique el Password..." maxlength="20" size="20"></td>
                                                </tr>
                                                <tr>
