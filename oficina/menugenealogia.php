...
echo '<form method="post" action="genealogia.php?c='.$_SESSION["codigo"].'">';
	...
	echo '<p align="center"><input type="submit" name="ordenar" class="btn btn-primary btn-block" value="Ver diagrama de organización"></p>';
...
echo '<form method="post" action="patrocinio.php?c='.$_SESSION["codigo"].'">';
	...
	echo '<p align="center"><input type="submit" name="ordenar" class="btn btn-primary btn-block" value="Ver red de patrocinados"></p>';
