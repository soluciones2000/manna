					...
					echo '<form name="pago" method="post" action="guardapago.php">';
						echo '<table border=0>';
							...
							echo '<tr>';
								...
								echo '<td><INPUT type="text" name="documento" maxlength="20" size="20" pattern="[0-9]{0,20}" title="Introduzca el número de comprobante (sólo números)" required><br></td>';
							echo '</tr>';
							echo '<tr>';
								echo '<td>Banco de origen:</td>';
								echo '<td><INPUT type="text" name="bancoorigen" maxlength="150" size="50" title="Introduzca el nombre del banco de origen"><br></td>';
							echo '</tr>';
							echo '<tr>';
								echo '<td>Monto del pago:</td>';
								echo '<td><INPUT type="currency" name="monto" maxlength="20" size="20" pattern="\d+(.\d{2})?" title="Introduzca el monto usando el punto (.) como separador decimal" style="text-align:right" required><br></td>';
							echo '</tr>';
							echo '<tr>';
								echo '<td>Número de orden:</td>';
								echo '<td><INPUT type="text" name="orden_id" maxlength="20" size="20"  pattern="[0-9]{0,20}" title="Introduzca el número de la orden que está cancelando (sólo números)" style="text-align:right"><br></td>';
							echo '</tr>';
						echo '</table>';
						echo '<br>';
