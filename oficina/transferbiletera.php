							...
							<form name="pago" method="post" action="confirmatransf.php">
								<table border=0>
									<tr>
										...
										<td><INPUT type="text" name="target" maxlength="5" size="5" title="Introduzca el código del afiliado al que desea transferir" required><br></td>
									</tr>
									<tr>
										<td>Monto:</td>
										<td><INPUT type="currency" name="monto" maxlength="15" size="15" pattern="\d+(.\d{2})?" title="Introduzca el monto usando el punto (.) como separador decimal" style="text-align:right" required><br></td>
									</tr>
								</table>
								<br>
