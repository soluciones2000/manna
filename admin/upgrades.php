...
$query = "SELECT upgrade.*,transacciones.precio,afiliados.tipo_afiliado as tipoinicial,afiliados.tipo_kit from upgrade left outer join transacciones on upgrade.codigo=transacciones.afiliado left outer join afiliados on upgrade.codigo=afiliados.tit_codigo where transacciones.tipo='01' and upgrade.status_upgrade='Pendiente' order by codigo";
