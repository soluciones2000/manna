...
$first = true;
echo '<form name="gestion" method="post" action="totreembolsoindividual.php">';
while($row = mysql_fetch_array($result)) {
	...
	echo '<div class="caracter"></div>';
	echo '<div class="detalle">'.'<input type="checkbox" name="'.trim($id).'"/> Pagar</div>'."<br>";
}
echo '<div style="text-align:right;padding-right:28%;">';
	echo '<br>';
