...
echo '<div id="cuerpo">';
	echo '<div style="text-align:center">';
		echo '<h3>BONOS UNILEVEL INDIVIDUALES POR PAGAR<br>';
...
$tot_gen = 0.00;
$grupo = 1;
echo '<form name="gestion" method="post" action="totunilevelindividual.php">';
while($row = mysql_fetch_array($result)) {
	...
	$txt .= '<div class="nombre">'.$organizacion." ".$org_nombres.'</div>';
	...
	$txt .= '<div class="caracter"></div>';
	$txt .= '<div class="codigo">'.'<input type="checkbox" name="'.trim($id).'"/> Pagar</div>'."<br>";
